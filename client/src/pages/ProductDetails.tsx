  ...
  return (
    <div className="bg-background min-h-screen pt-8 pb-32">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col">
            <div className="mb-8">
              <div className="inline-flex items-center px-3 py-1 text-xs font-semibold uppercase tracking-wider rounded-full bg-[hsl(var(--success))]/10 text-[hsl(var(--success))] mb-4 border border-[hsl(var(--success))]/20">
                {product.deviceType === 'refurbished' ? t('product.refurbished', 'Refurbished') : t('product.assembled', 'Assembled')}
              </div>
            ...
            <div className="grid grid-cols-2 gap-4 mb-10 cursor-default">
              <div className="bg-surface p-4 rounded-2xl flex items-start gap-4 border border-border/50">
                ...
                <div>
                  <div className="text-sm text-muted-foreground mb-1">{t('product.condition', 'Device Condition')}</div>
                  ...
                  <div className="text-xs text-[hsl(var(--success))] font-medium mt-1 cursor-text">{t('product.pristineCondition', 'Pristine - Like New')}</div>
                </div>
              </div>
              <div className="bg-surface p-4 rounded-2xl flex items-start gap-4 border border-border/50">
                <div className="w-10 h-10 rounded-full bg-background flex items-center justify-center text-foreground shadow-sm border border-border/50">
                ...
                <div>
                  ...
                  <div className="text-xs text-[hsl(var(--success))] font-medium mt-1 cursor-text">{t('product.originalBattery', 'Original Superior Battery')}</div>
                </div>
              </div>
            </div>
        ...
        {/* Reviews Section */}
        <div className="border-t border-border pt-16 mt-16 cursor-default">
